...
var YoutubeReact = function (_Component) {
    ...
    function YoutubeReact() {
        ...
        var _this = _possibleConstructorReturn(this, (YoutubeReact.__proto__ || Object.getPrototypeOf(YoutubeReact)).call(this));

        _this.playVideo = _this.playVideo.bind(_this);
        _this.mountPlayer = _this.mountPlayer.bind(_this);
        _this.configPlayer = _this.configPlayer.bind(_this);
        return _this;
    }
    ...
    _createClass(YoutubeReact, [{
        ...
        value: function mountPlayer() {
            ...
            if (this.player) {
                var oldPlayer = window.document.getElementById("youtube-react-player");
            ...
            this.player = new window.YT.Player('youtube-react-player', {
                ...
                events: {
                    'onReady': function onReady(e) {
                        if (_this2.props.onReady) _this2.props.onReady();
                    },
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement('div', { id: 'youtube-react-player' })
            );
        }
    }]);
...
var oneOrZero = function oneOrZero(props, propName, componentName) {
